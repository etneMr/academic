  ...
  return (
    <div id="teacher-details">
      <div className="teacher-details-header">
        <div className="header-text">Teacher Details</div>
        <StatusBar />
      </div>
...
function TeacherDetailsComponent({ teacher }) {
  return (
    <div className="teacher-detail-container">
      <div className="teacher-header-background"></div>
      ...
      <div className="content">
        ...
        <div className="subject">{teacher.category}</div>
        <div className="contact">
          <div className="contact-item">
            ...
            <div className="contact-item-text">{teacher.brand}</div>
          </div>
          <div className="contact-item">
            <div className="contact-icon">
              <svg
            ...
            <div className="contact-item-text">+12 345 6789 0</div>
          </div>
          <div className="contact-item">
            <div className="contact-icon">
              <svg
            ...
            <div className="contact-item-text">Historia@mail.com</div>
          </div>
        </div>
        <h3>About:</h3>
        ...
        <ul>
          <li className="education-item">
            ...
            <div className="period">2013-2017</div>
          </li>
          <li className="education-item">
  ...
  return (
    <div className="schedule-details">
      <div className="header-component">
        <h3 style={{ paddingBottom: "8px" }}>Schedule Details</h3>
        <div>Thursday, 10th April , 2021</div>
      </div>
