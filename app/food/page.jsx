      ...
      <tr className="food-item" rowspan={7}>
        ...
        <td>
          <div className="food-rating">
            ...
            <div className="food-rating-text">
              {food.rating}
            </div>
          </div>
        </td>
        <td>
          <div className="food-order-info">
            ...
            <div className="food-order-detail">
              ...
              <div className="total-order-text">
                Total Order
              </div>
            </div>
          </div>
        ...
        <td>
          <div className="food-trending">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <path d="M39.9411 3.05888C39.9411 1.40202 38.598 0.0588757 36.9411 0.0588763L9.94113 0.0588746C8.28427 0.0588746 6.94113 1.40202 6.94113 3.05888C6.94113 4.71573 8.28427 6.05888 9.94113 6.05888H33.9411V30.0589C33.9411 31.7157 35.2843 33.0589 36.9411 33.0589C38.598 33.0589 39.9411 31.7157 39.9411 30.0589L39.9411 3.05888ZM5.12132 39.1213L39.0624 5.1802L34.8198 0.937555L0.87868 34.8787L5.12132 39.1213Z" fill="#4D44B5" />
            </svg>
        ...
        <td>
          <div className="food-percentage">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
              ...
              <path d="M30 60C22.0435 60 14.4129 56.8393 8.7868 51.2132C3.1607 45.5871 -2.21335e-07 37.9565 0 30C2.21335e-07 22.0435 3.16071 14.4129 8.7868 8.7868C14.4129 3.1607 22.0435 -9.48802e-08 30 0V6C23.6348 6 17.5303 8.52856 13.0294 13.0294C8.52856 17.5303 6 23.6348 6 30C6 36.3652 8.52856 42.4697 13.0294 46.9706C17.5303 51.4714 23.6348 54 30 54V60Z" fill="#4D44B5" />
            </svg>
            <div className="food-percentage-text">
              50%
            </div>
          </div>
        </td>
      ...
      <div className="food-table-header" >
        ...
        <div className="food-category">
          <div className="food-category-item">
            <div className="food-category-text">
              All Menus
            </div>
          </div>
          <div className="food-category-item">
