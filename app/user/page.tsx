...
import { getUser } from "@/lib/functions/auth";
...
function PlanComponent() {
  return (
    <div className="plan-component">
      ...
      <div style={{ width: "275px", zIndex: "10", position: "relative" }}>
...
function LastActivityComponent({ listActivities }) {
  const rows = [];
  listActivities.map((activities: any) => {
    rows.push(
      <div className="activity-item">
        ...
        <div className="details">
          ...
          <div className="date">2 March 2021, 13:45 PM</div>
        </div>
      </div>
    );
  });
